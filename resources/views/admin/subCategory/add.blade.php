...
@section('content')
    <div class="container-xxl flex-grow-1 container-p-y">
        <h4 class="py-3 mb-4"><span class="text-muted fw-light">Sub Category /</span> Add</h4>
            ...
            <div class="col">
                <div class="card shadow mb-4">
                    ...
                    <div class="card-header d-flex align-items-center justify-content-between">
                        <h5 class="mb-0">Add New Sub Category</h5> <small class="text-muted float-end">subcategory
                            information</small>
                    </div>
